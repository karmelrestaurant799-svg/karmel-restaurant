// Canonical UI text. Deliberately NOT a "use client" module: the server (api/translate-ui)
// must translate *this* German source and never a dictionary supplied by the caller,
// otherwise any visitor could get arbitrary text cached as the site translation for everyone.

export type Language = "de" | "en" | "es" | "fr" | "it" | "nl" | "tr" | "pl" | "ru" | "ar" | "zh" | "ja";
